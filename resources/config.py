...
c.TagRemovePreprocessor.remove_all_outputs_tags = set(['remove-output'])
c.TagRemovePreprocessor.remove_input_tags = set(['remove-input'])

c.Exporter.preprocessors = ['versionpreproc.inject_version']

c.SlidesExporter.template_name = 'sdsaitemplate'
c.WebPDFExporter.template_name = 'sdsaitemplate'

c.WebPDFExporter.allow_chromium_download = True
c.WebPDFExporter.embed_images = True
c.WebPDFExporter.paginate = True
c.WebPDFExporter.exclude_anchor_links = True
